 ...
 * @author PC-Eger
 */
public class TelaCadastarReceita extends javax.swing.JDialog {
...
//    private List<Cartaodecredito> listaCartao = new ArrayList<>();
    ...
    public TelaCadastarReceita(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public TelaCadastarReceita(TelaMovimentacao parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = parent;
        movimentacao = new Movimentacao();
...
//        }
   ...
   private Movimentacao getMovimentacaoDespesa() {
        ...
        movimentacao.setTipoMovi("Receita");
        movimentacao.setIdCategoria(listaCategoria.get(cbCategoria.getSelectedIndex()-1));
        movimentacao.setValorMovi(Double.parseDouble(txValorDespesa.getText().replace(",", ".")));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txData, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCadastarReceita dialog = new TelaCadastarReceita(new javax.swing.JFrame(), true);
